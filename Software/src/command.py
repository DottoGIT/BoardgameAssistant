...
class Command():
    ...
    def send_init(self, template, resource_amt, resources, players, dice, dice_amount):
        self._command = 'init'
        command = {}
        command['command'] = 'init'
        command['template'] = template
        command['resource_amount'] = resource_amt
        command['resources'] = resources
        command['players'] = players
        command['dice'] = dice
        command['dice_amount'] = dice_amount
        self._command_dict = command
        self._command_string = json.dumps(command)
        return self._command_string

    def send_load(self, template, resource_amt, resources, players, dice, dice_amount):
        self._command = 'load'
        command = {}
